...
-   1.3.0-alpha-debian 1.3-debian debian  (`images/1.3/buster/Dockerfile`)
-   1.3.0-alpha-debian-slim 1.3-debian-slim debian-slim  (`images/1.3/buster-slim/Dockerfile`)
